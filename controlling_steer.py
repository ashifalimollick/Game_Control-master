...
# -*- coding: utf-8 -*-
"""
@Author: Ashif Ali Mollick
@Linkedin: https://www.linkedin.com/in/ashif-ali-mollick-750b65161/
@Discription: Simulate a real life like steering wheel control in a racing game using openCV
...
while True:
    ...
    #Comment this step if your video frame is not flipped by default. My video frame was flipped horizontally.
    ...
    # crteate a mask for the blue color and perform opening and closing to remove any blobs left in the mask 
